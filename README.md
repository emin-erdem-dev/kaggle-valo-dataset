...
Kaggle Notebook: [https://www.kaggle.com/code/muhammederdem69/valorant-pro-match](https://www.kaggle.com/code/muhammederdem69/valorant-pro-match)

---

KULLANILAN TEKNOLOJİLER (TECH STACK)
Bu projede standart bir kopyala-yapıştır mantığıyla değil, sektör standartlarında Veri Bilimi araçlarıyla ilerledik:
...
Sadece rakamlara bakmadık, "Bu rakam bize maç hakkında ne anlatıyor?" sorusuna odaklandık. 
...
GitHub Platformu: [](https://github.com/muhammederdem69)
